export default function WhoWeAre() {
  return (
    <section className="who-we-are">
      ...
      <p>
        Founded in January 2018, ARI has received recognition and generous support from other University of Michigan organizations. 
        In April 2018, ARI received a $5,000 optiMize project grant and was accepted into the competitive Barger Leadership Institute Capstone program.
        In April 2019, ARI hosted the first ever XR Midwest Conference.
      </p>
    </section>
  );
}
